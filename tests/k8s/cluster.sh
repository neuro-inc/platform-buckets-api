...
function k8s::apply_all_configurations {
    ...
    kubectl apply -f charts/platform-buckets/templates/crd-userbucket.yml
    kubectl apply -f charts/platform-buckets/templates/crd-persistentbucketcredential.yml
}
